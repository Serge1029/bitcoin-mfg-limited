                    ...
                    <div class="product-description">
                      ...
                      <hr>
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-7">
                            <input type="text" class="input-field" name="lang69" placeholder="Login / Register" required="" value="{{ $lang->lang69 }}">
                          </div>
                        </div>
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-7">
                            <input type="text" class="input-field" name="lang70" placeholder="My Account" required="" value="{{ $lang->lang70 }}">
                          </div>
                        </div>
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-7">
                            <input type="text" class="input-field" name="lang71" placeholder="Dashboard" required="" value="{{ $lang->lang71 }}">
                          </div>
                        </div>
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-7">
                            <input type="text" class="input-field" name="lang72" placeholder="Edit Profile" required="" value="{{ $lang->lang72 }}">
                          </div>
                        </div>
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-7">
                            <input type="text" class="input-field" name="lang73" placeholder="Change Password" required="" value="{{ $lang->lang73 }}">
                          </div>
                        </div>
                      ...
                      <hr>
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-7">
                            <input type="text" class="input-field" name="lang54" placeholder="What We Do" required="" value="{{ $lang->lang54 }}">
                          </div>
                        </div>
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-7">
                            <input type="text" class="input-field" name="lang55" placeholder="Contact Now" required="" value="{{ $lang->lang55 }}">
                          </div>
                        </div>
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-7">
                            <input type="text" class="input-field" name="lang56" placeholder="Type" required="" value="{{ $lang->lang56 }}">
                          </div>
                        </div>
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-7">
                            <input type="text" class="input-field" name="lang57" placeholder="Date" required="" value="{{ $lang->lang57 }}">
                          </div>
                        </div>
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-7">
                            <input type="text" class="input-field" name="lang58" placeholder="Invest Amount" required="" value="{{ $lang->lang58 }}">
                          </div>
                        </div>
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-7">
                            <input type="text" class="input-field" name="lang59" placeholder="Time Left" required="" value="{{ $lang->lang59 }}">
                          </div>
                        </div>
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-7">
                            <input type="text" class="input-field" name="lang60" placeholder="Payout Amount" required="" value="{{ $lang->lang60 }}">
                          </div>
                        </div>
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-7">
                            <input type="text" class="input-field" name="lang61" placeholder="Invest" required="" value="{{ $lang->lang61 }}">
                          </div>
                        </div>
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-7">
                            <input type="text" class="input-field" name="lang62" placeholder="Payout" required="" value="{{ $lang->lang62 }}">
                          </div>
                        </div>
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-7">
                            <input type="text" class="input-field" name="lang63" placeholder="Bonus in" required="" value="{{ $lang->lang63 }}">
                          </div>
                        </div>
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-7">
                            <input type="text" class="input-field" name="lang64" placeholder="day(s)" required="" value="{{ $lang->lang64 }}">
                          </div>
                        </div>
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-7">
                            <input type="text" class="input-field" name="lang65" placeholder="Minimum Invest:" required="" value="{{ $lang->lang65 }}">
                          </div>
                        </div>
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-7">
                            <input type="text" class="input-field" name="lang66" placeholder="Invest:" required="" value="{{ $lang->lang66 }}">
                          </div>
                        </div>
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-7">
                            <input type="text" class="input-field" name="lang67" placeholder="Get:" required="" value="{{ $lang->lang67 }}">
                          </div>
                        </div>
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-7">
                            <input type="text" class="input-field" name="lang68" placeholder="INVEST NOW" required="" value="{{ $lang->lang68 }}">
                          </div>
                        </div>
                      ...
                      <hr>
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-7">
                            <input type="text" class="input-field" name="blockchain" placeholder="Blockchain" required="" value="{{ $lang->blockchain }}">
                          </div>
                        </div>
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-7">
                            <input type="text" class="input-field" name="coinpayment" placeholder="Coinpayment" required="" value="{{ $lang->coinpayment }}">
                          </div>
                        </div>
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-7">
                            <input type="text" class="input-field" name="blockio_btc" placeholder="Block.io (Bitcoin)" required="" value="{{ $lang->blockio_btc }}">
                          </div>
                        </div>
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-7">
                            <input type="text" class="input-field" name="blockio_ltc" placeholder="Block.io (Litecoin)" required="" value="{{ $lang->blockio_ltc }}">
                          </div>
                        </div>
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-7">
                            <input type="text" class="input-field" name="blockio_dgc" placeholder="Block.io (Dogecoin)" required="" value="{{ $lang->blockio_dgc }}">
                          </div>
                        </div>
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-7">
                            <input type="text" class="input-field" name="vougepay" placeholder="VougePay" required="" value="{{ $lang->vougepay }}">
                          </div>
                        </div>
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-7">
                            <input type="text" class="input-field" name="coingate" placeholder="Coingate" required="" value="{{ $lang->coingate }}">
                          </div>
                        </div>
                      ...
                      <hr>
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-7">
                            <input type="text" class="input-field" name="lang172" placeholder="Login" required="" value="{{ $lang->lang172 }}">
                          </div>
                        </div>
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-7">
                            <input type="text" class="input-field" name="lang176" placeholder="Forgotten your password?" required="" value="{{ $lang->lang176 }}">
                          </div>
                        </div>
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-7">
                            <input type="text" class="input-field" name="lang181" placeholder="Register" required="" value="{{ $lang->lang181 }}">
                          </div>
                        </div>
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-7">
                            <input type="text" class="input-field" name="lang188" placeholder="Processing..." required="" value="{{ $lang->lang188 }}">
                          </div>
                        </div>
                      ...
                      <hr>
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-7">
                            <input type="text" class="input-field" name="lang75" placeholder="Your investment is successfull." required="" value="{{ $lang->lang75 }}">
                          </div>
                        </div>
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-7">
                            <input type="text" class="input-field" name="lang76" placeholder="Your investment is completed." required="" value="{{ $lang->lang76 }}">
                          </div>
                        </div>
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-7">
                            <input type="text" class="input-field" name="lang77" placeholder="Your withdraw is successfull." required="" value="{{ $lang->lang77 }}">
                          </div>
                        </div>
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-7">
                            <input type="text" class="input-field" name="lang78" placeholder="Clear All" required="" value="{{ $lang->lang78 }}">
                          </div>
                        </div>
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-7">
                            <input type="text" class="input-field" name="lang79" placeholder="No New Notifications" required="" value="{{ $lang->lang79 }}">
                          </div>
                        </div>
                      ...
                      <hr>
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-7">
                            <input type="text" class="input-field" name="lang201" placeholder="Invests" required="" value="{{ $lang->lang201 }}">
                          </div>
                        </div>
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-7">
                            <input type="text" class="input-field" name="lang202" placeholder="Payouts" required="" value="{{ $lang->lang202 }}">
                          </div>
                        </div>
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-7">
                            <input type="text" class="input-field" name="lang204" placeholder="Transactions" required="" value="{{ $lang->lang204 }}">
                          </div>
                        </div>
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-7">
                            <input type="text" class="input-field" name="lang205" placeholder="Invest Now" required="" value="{{ $lang->lang205 }}">
                          </div>
                        </div>
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-7">
                            <input type="text" class="input-field" name="lang206" placeholder="Referral Code" required="" value="{{ $lang->lang206 }}">
                          </div>
                        </div>
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-7">
                            <input type="text" class="input-field" name="lang207" placeholder="Edit Profile" required="" value="{{ $lang->lang207 }}">
                          </div>
                        </div>
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-7">
                            <input type="text" class="input-field" name="lang208" placeholder="Change Password" required="" value="{{ $lang->lang208 }}">
                          </div>
                        </div>
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-7">
                            <input type="text" class="input-field" name="lang209" placeholder="Logout" required="" value="{{ $lang->lang209 }}">
                          </div>
                        </div>
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-7">
                            <input type="text" class="input-field" name="lang210" placeholder="Current Balance" required="" value="{{ $lang->lang210 }}">
                          </div>
                        </div>
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-7">
                            <input type="text" class="input-field" name="lang211" placeholder="Need help?" required="" value="{{ $lang->lang211 }}">
                          </div>
                        </div>
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-7">
                            <textarea class="input-field" name="lang212" required="" placeholder="Have questions or concerns regrading your account? Our experts are here to help!.">{{ $lang->lang212 }}</textarea>
                          </div>
                        </div>
                      ...
                      <hr>
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-7">
                            <input type="text" class="input-field" name="lang213" placeholder="Recent Transactions" required="" value="{{ $lang->lang213 }}">
                          </div>
                        </div>
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-7">
                            <input type="text" class="input-field" name="lang214" placeholder="Type" required="" value="{{ $lang->lang214 }}">
                          </div>
                        </div>
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-7">
                            <input type="text" class="input-field" name="lang215" placeholder="Txnid" required="" value="{{ $lang->lang215 }}">
                          </div>
                        </div>
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-7">
                            <input type="text" class="input-field" name="lang216" placeholder="Amount" required="" value="{{ $lang->lang216 }}">
                          </div>
                        </div>
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-7">
                            <input type="text" class="input-field" name="lang217" placeholder="Date" required="" value="{{ $lang->lang217 }}">
                          </div>
                        </div>
                      ...
                      <hr>
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-7">
                            <input type="text" class="input-field" name="lang218" placeholder="Invests" required="" value="{{ $lang->lang218 }}">
                          </div>
                        </div>
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-7">
                            <input type="text" class="input-field" name="lang219" placeholder="Payouts" required="" value="{{ $lang->lang219 }}">
                          </div>
                        </div>
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-7">
                            <input type="text" class="input-field" name="lang220" placeholder="Plan" required="" value="{{ $lang->lang220 }}">
                          </div>
                        </div>
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-7">
                            <input type="text" class="input-field" name="lang221" placeholder="Method" required="" value="{{ $lang->lang221 }}">
                          </div>
                        </div>
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-7">
                            <input type="text" class="input-field" name="lang222" placeholder="Payouts" required="" value="{{ $lang->lang222 }}">
                          </div>
                        </div>
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-7">
                            <input type="text" class="input-field" name="lang500" placeholder="Paid" required="" value="{{ $lang->lang500 }}">
                          </div>
                        </div>
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-7">
                            <input type="text" class="input-field" name="lang223" placeholder="Time Left" required="" value="{{ $lang->lang223 }}">
                          </div>
                        </div>
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-7">
                            <input type="text" class="input-field" name="lang224" placeholder="Get" required="" value="{{ $lang->lang224 }}">
                          </div>
                        </div>
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-7">
                            <input type="text" class="input-field" name="lang225" placeholder="VIEW MORE" required="" value="{{ $lang->lang225 }}">
                          </div>
                        </div>
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-7">
                            <input type="text" class="input-field" name="lang226" placeholder="Investment Details" required="" value="{{ $lang->lang226 }}">
                          </div>
                        </div>
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-7">
                            <input type="text" class="input-field" name="lang227" placeholder="Back" required="" value="{{ $lang->lang227 }}">
                          </div>
                        </div>
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-7">
                            <input type="text" class="input-field" name="lang228" placeholder="Transaction ID" required="" value="{{ $lang->lang228 }}">
                          </div>
                        </div>
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-7">
                            <input type="text" class="input-field" name="lang229" placeholder="Pricing Plan" required="" value="{{ $lang->lang229 }}">
                          </div>
                        </div>
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-7">
                            <input type="text" class="input-field" name="lang230" placeholder="Payment Method" required="" value="{{ $lang->lang230 }}">
                          </div>
                        </div>
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-7">
                            <input type="text" class="input-field" name="lang231" placeholder="Invest" required="" value="{{ $lang->lang231 }}">
                          </div>
                        </div>
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-7">
                            <input type="text" class="input-field" name="lang232" placeholder="Get" required="" value="{{ $lang->lang232 }}">
                          </div>
                        </div>
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-7">
                            <input type="text" class="input-field" name="lang233" placeholder="Transaction ID" required="" value="{{ $lang->lang233 }}">
                          </div>
                        </div>
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-7">
                            <input type="text" class="input-field" name="lang234" placeholder="Charge ID" required="" value="{{ $lang->lang234 }}">
                          </div>
                        </div>
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-7">
                            <input type="text" class="input-field" name="lang235" placeholder="Payment Status" required="" value="{{ $lang->lang235 }}">
                          </div>
                        </div>
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-7">
                            <input type="text" class="input-field" name="lang236" placeholder="Date" required="" value="{{ $lang->lang236 }}">
                          </div>
                        </div>
                      ...
                      <hr>
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-7">
                            <input type="text" class="input-field" name="lang322" placeholder="Referral Informations" required="" value="{{ $lang->lang322 }}">
                          </div>
                        </div>
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-7">
                            <input type="text" class="input-field" name="lang323" placeholder="Your Referral Link *" required="" value="{{ $lang->lang323 }}">
                          </div>
                        </div>
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-7">
                            <input type="text" class="input-field" name="lang324" placeholder="This is your referral link just copy the link and paste anywhere you want." required="" value="{{ $lang->lang324 }}">
                          </div>
                        </div>
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-7">
                            <input type="text" class="input-field" name="lang325" placeholder="Referral Banner *" required="" value="{{ $lang->lang325 }}">
                          </div>
                        </div>
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-7">
                            <input type="text" class="input-field" name="lang326" placeholder="This is your referral banner Preview." required="" value="{{ $lang->lang326 }}">
                          </div>
                        </div>
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-7">
                            <input type="text" class="input-field" name="lang327" placeholder="Referral Banner HTML Code *" required="" value="{{ $lang->lang327 }}">
                          </div>
                        </div>
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-7">
                            <input type="text" class="input-field" name="lang328" placeholder="This is your referral banner html code just copy the code and paste anywhere you want." required="" value="{{ $lang->lang328 }}">
                          </div>
                        </div>
                      ...
                      <hr>
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-7">
                            <input type="text" class="input-field" name="lang272" placeholder="Change Password" required="" value="{{ $lang->lang272 }}">
                          </div>
                        </div>
                      ...
                      <hr>
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-7">
                            <input type="text" class="input-field" name="lang376" placeholder="Support Tickets" required="" value="{{ $lang->lang376 }}">
                          </div>
                        </div>
                      ...
                      <hr>
                        ...
                        <div class="row">
                          ...
                          <div class="row">
                              ...
                              <div class="col-lg-7">
                                  <div class="tawk-area">
                                    <textarea  class="input-field"  name="order_title" required="">{{ $lang->order_title }}</textarea>
                                  </div>
                              </div>
                            </div>
                          ...
                          <div class="row">
                              ...
                              <div class="col-lg-7">
                                  <div class="tawk-area">
                                    <textarea  class="input-field"  name="order_text" required="">{{ $lang->order_text }}</textarea>
                                  </div>
                              </div>
                            </div>
