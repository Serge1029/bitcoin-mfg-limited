				...
				<div class="wrapper">
					...
					<nav id="sidebar" class="nav-sidebar">
						<ul class="list-unstyled components" id="accordion">
							...
							<li>
								<a href="#order" class="accordion-toggle wave-effect" data-toggle="collapse" aria-expanded="false"><i class="fas fa-hand-holding-usd"></i>Invests</a>
								<ul class="collapse list-unstyled" id="order" data-parent="#accordion" >
                                   	<li>
                                    	<a href="{{route('admin-order-index')}}"> All Invests</a>
                                	</li>
                                    <li>
                                        <a href="{{route('admin-order-pending')}}"> Pending Invests</a>
                                    </li>
                                    <li>
                                        <a href="{{route('admin-order-completed')}}"> Completed Invests</a>
                                    </li>
                                    <li>
                                        <a href="{{route('admin-order-declined')}}"> Declined Invests</a>
                                    </li>  
							...
							<li>
								<a href="{{ route('admin-trans-index') }}" class=" wave-effect"><i class="fas fa-credit-card"></i>Transactions</a>
							</li>
							...
							<li>
								<a href="{{ route('admin-message-index') }}" class=" wave-effect"><i class="fas fa-envelope"></i>Support Tickets</a>
							</li>
							...
							<li>
								...
								<ul class="collapse list-unstyled" id="general" data-parent="#accordion">
                                    ...
                                    <li>
                                    	<a href="{{ route('admin-gs-affilate') }}"><span>Referral Informations</span></a>
                                    </li>
							...
							<li>
								...
								<ul class="collapse list-unstyled" id="homepage" data-parent="#accordion">
                                    ...
                                    <li>
                                    	<a href="{{ route('admin-ps-banner') }}"><span>Banner Informations</span></a>
                                    </li>
                                    ...
                                    <li>
                                    	<a href="{{ route('admin-ps-trans') }}"><span>Transaction Section</span></a>
                                    </li>
                                    <li>
							...
							<li>
								...
								<ul class="collapse list-unstyled" id="payments" data-parent="#accordion">
                                    ...
                                    <li><a href="{{route('admin-gs-currency')}}"><span>Currency</span></a></li>  
								</ul>
							</li>
