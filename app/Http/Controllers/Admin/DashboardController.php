...
class DashboardController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.dashboard',compact('pending','processing','completed','products','blogs','activation_notify'));
    }
    ...
    public function transDatatables()
    {
         ...
         return Datatables::of($datas)
                            ...
                            ->addColumn('action', function(Transaction $data) {
                                return '<div class="action-list"><a href="javascript:;" class="send" data-email="'. $data->email .'" data-toggle="modal" data-target="#vendorform"><i class="fas fa-envelope"></i> Send Email</a></div>';
                            }) 
                            ->rawColumns(['action'])
