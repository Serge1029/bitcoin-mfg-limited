...
@section('content')  
                    <div class="content-area">
                        <div class="mr-breadcrumb">
                            <div class="row">
                                <div class="col-lg-12">
                                        <h4 class="heading">Processing Invests</h4>
                                        <ul class="links">
                                            <li>
                                                <a href="{{ route('admin.dashboard') }}">Dashboard </a>
                                            </li>
                                            <li>
                                                <a href="javascript:;">Invests</a>
                                            </li>
                                            <li>
                                                <a href="{{ route('admin-order-processing') }}">Processing Invests</a>
                                            </li>
                                        </ul>
                                </div>
                            </div>
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-header d-block text-center">
      ...
      <div class="modal-body">
        <p class="text-center">You are about to update the Invest's Status.</p>
