...
@section('content')
    <div class="content-area">
                        <div class="mr-breadcrumb">
                            <div class="row">
                                <div class="col-lg-12">
                                        <h4 class="heading">Investment Details  <a class="add-btn" href="javascript:history.back();"><i class="fas fa-arrow-left"></i> Back</a></h4>
                                        <ul class="links">
                                            <li>
                                            ...
                                            <li>
                                                <a href="javascript:;">Investment Details</a>
                                            </li>
                                        </ul>
                                </div>
                            </div>
