...
class GeneralSettingController extends Controller
{
    ...
    public function blockchain($status)
    {

        $data = Generalsetting::findOrFail(1);
        $data->blockchain_check = $status;
        $data->update();
    }

    public function coinpayment($status)
    {

        $data = Generalsetting::findOrFail(1);
        $data->coinpayment_check = $status;
        $data->update();
    }

    public function gatewayStatus($status,$column)
    {
    ...
    public function iscurrency($status)
    {
        $data = Generalsetting::findOrFail(1);
