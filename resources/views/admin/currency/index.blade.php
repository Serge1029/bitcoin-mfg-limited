								...
								<div class="heading-area">
	                                ...
	                                <div class="action-list">
	                                    <select class="process select droplinks {{ $gs->is_currency== 1 ? 'drop-success' : 'drop-danger' }}">
	                                      <option data-val="1" value="{{route('admin-gs-iscurrency',1)}}" {{ $gs->is_currency == 1 ? 'selected' : '' }}>Activated</option>
	                                      <option data-val="0" value="{{route('admin-gs-iscurrency',0)}}" {{ $gs->is_currency == 0 ? 'selected' : '' }}>Deactivated</option>
	                                    </select>
	                                  </div>
								</div>  
