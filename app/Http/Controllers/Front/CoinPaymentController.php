...
class CoinPaymentController extends Controller
{
    ...
    public function deposit(Request $request)
    {
        ...
        $coin_amount = file_get_contents('https://blockchain.info/tobtc?currency='.$currency_code.'&value='.$request->invest);

        $secret = $generalsettings->secret_string;
        $coin_public = $generalsettings->coin_public_key;
        $coin_private = $generalsettings->coin_private_key;
