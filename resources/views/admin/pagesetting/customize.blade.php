...
<div class="content-area">
              ...
              <div class="add-product-content">
                ...
                <div class="row justify-content-center">
                  ...
                  <label class="control-label" for="slider">Features *</label>
                  ...
                  <div class="col-lg-4 d-flex justify-content-between">
                  <label class="control-label" for="service">Welcome Informations *</label>
                    <label class="switch float-right">
                ...
                <div class="row justify-content-center">
                  <div class="col-lg-4 d-flex justify-content-between">
                  <label class="control-label" for="pricing_plan">Services *</label>
                    <label class="switch float-right">
                  ...
                  <div class="col-lg-2"></div>
                  <div class="col-lg-4 d-flex justify-content-between">
                  <label class="control-label" for="top_rated">Contact Section *</label>
                    <label class="switch float-right">
                ...
                <div class="row justify-content-center">
                  <div class="col-lg-4 d-flex justify-content-between">
                  <label class="control-label" for="large_banner">Transactions Section *</label>
                    <label class="switch float-right">
                  ...
                  <div class="col-lg-2"></div>
                  <div class="col-lg-4 d-flex justify-content-between">
                  <label class="control-label" for="big">Review Section *</label>
                    <label class="switch float-right">
                ...
                <div class="row justify-content-center">
                  <div class="col-lg-4 d-flex justify-content-between">
                  <label class="control-label" for="hot_sale">Pricing Plans *</label>
                    <label class="switch float-right">
